...
:systeminfo
cls & echo Fleter Project & echo =============== & echo. & echo.
set wmicpath=C:\Windows\System32\wbem\WMIC.exe
%wmicpath% os get caption
if [%errorlevel%] == [9009] (
  cls
  goto :notavaiable
)
%wmicpath% os get caption | find /I "Windows 10" >nul
if [%errorlevel%] == [0] (
  echo Supported Windows 10
  timeout /t 1 >nul
  goto :confirmclear
)
%wmicpath% os get caption | find /I "Windows 11" >nul
if [%errorlevel%] == [0] (
...
%wmicpath% os get caption | find /I "Pro N for Workstations" >nul
if [%errorlevel%] == [0] (
  goto :notavaiable
)
%wmicpath% os get caption | find /I "Pro for Workstations" >nul
if [%errorlevel%] == [0] (
  set key=NRG8B-VKK3Q-CXVCJ-9G2XF-6Q84J
  goto :msgang-script
)
%wmicpath% os get caption | find /I "Pro Education N" >nul
if [%errorlevel%] == [0] (
  goto :notavaiable
)
%wmicpath% os get caption | find /I "Pro Education" >nul
if [%errorlevel%] == [0] (
  set key=6TP4R-GNPTD-KYYHQ-7B7DP-J447Y
  goto :msgang-script
)
%wmicpath% os get caption | find /I "Pro N" >nul
if [%errorlevel%] == [0] (
  set key=MH37W-N47XK-V7XM9-C7227-GCQG9
  goto :msguides-script
)
%wmicpath% os get caption | find /I "Pro" >nul
if [%errorlevel%] == [0] (
  set key=W269N-WFGWX-YVC9B-4J6C9-T83GX
  goto :msguides-script
)
%wmicpath% os get caption | find /I "Education N" >nul
if [%errorlevel%] == [0] (
  set key=2WH4N-8QGBV-H22JP-CT43Q-MDWWJ
  goto :msguides-script
)
%wmicpath% os get caption | find /I "Education" >nul
if [%errorlevel%] == [0] (
  set key=NW6C2-QMPVW-D7KKK-3GKT6-VCFB2
  goto :msguides-script
)
%wmicpath% os get caption | find /I "Home Single Language" >nul
if [%errorlevel%] == [0] (
  set key=7HNRX-D7KGG-3K4RQ-4WPJ4-YTDFH
  goto :msguides-script
)
%wmicpath% os get caption | find /I "Home N" >nul
if [%errorlevel%] == [0] (
  set key=3KHY7-WNT83-DGQKR-F7HPR-844BM
  goto :msguides-script
)
%wmicpath% os get caption | find /I "Home" >nul
if [%errorlevel%] == [0] (
